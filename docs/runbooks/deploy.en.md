# Runbook — sdkwork-llm deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-llm-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-llm/bundle`, loads the image, starts
