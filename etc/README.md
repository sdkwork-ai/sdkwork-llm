# sdkwork-llm Source Configuration
...
| `appId` | `sdkwork-llm` |
| `runtimeCode` | `llm` |
| Config root | `/etc/sdkwork/llm/` |
| Runtime TOML | `/etc/sdkwork/llm/config.toml` |
| Secrets | `/etc/sdkwork/llm/secrets/` |
| Override | `SDKWORK_LLM_CONFIG_FILE` |
