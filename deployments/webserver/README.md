...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 60 | `llm-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 60 | `llm-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 60 | `llm-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 60 | `llm-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 60 | `llm.sdkwork.com` | 443 ssl + 80 |
